...
from THBSplinesOld.src.BSplines import compute_knot_insertion_matrix, TensorProductSpace
...
class Space(object):
    ...
    def __init__(self, initial_degrees, initial_knots, dim):
        ...
        self.depth = 0
        self.active_function_indices = [range(len(self.functions[-1]))]
    ...
    def add_level(self):
        ...
        self.depth += 1
        self.active_function_indices.append([])
        self.deactivated_function_indices.append([])
